...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Geoname.searchable_name'
        db.add_column('geonames_geoname', 'searchable_name',
                      self.gf('django.db.models.fields.CharField')(max_length=200, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Geoname.searchable_name'
        db.delete_column('geonames_geoname', 'searchable_name')
    ...
    models = {
        ...
        'geonames.geoname': {
            ...
            'searchable_name': ('django.db.models.fields.CharField', [], {'max_length': '200', 'null': 'True', 'blank': 'True'}),
