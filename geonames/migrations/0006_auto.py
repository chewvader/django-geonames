...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding index on 'Geoname', fields ['searchable_name']
        db.create_index('geonames_geoname', ['searchable_name'])

    def backwards(self, orm):
        # Removing index on 'Geoname', fields ['searchable_name']
        db.delete_index('geonames_geoname', ['searchable_name'])
    ...
    models = {
        ...
        'geonames.geoname': {
            ...
            'searchable_name': ('django.db.models.fields.CharField', [], {'db_index': 'True', 'max_length': '200', 'null': 'True', 'blank': 'True'}),
